...
public class CheckpointSumTest {
    ...
    public void test() {
        ...
        Udaf<Struct, Double, Double> udaf = CheckpointSum.getUDAF();
        Double aggregate = udaf.initialize();

        Struct[] values = new Struct[]{
            new Struct(INPUT_STRUCT).put(CheckpointSum.TYPE, CheckpointSum.DELTA).put(
                CheckpointSum.VALUE, 1.0d),
            new Struct(INPUT_STRUCT).put(CheckpointSum.TYPE, CheckpointSum.DELTA).put(
                CheckpointSum.VALUE, 1.0d),
            new Struct(INPUT_STRUCT).put(CheckpointSum.TYPE, CheckpointSum.DELTA).put(
                CheckpointSum.VALUE, 1.0d)
        ...
        aggregate = udaf.aggregate(new Struct(INPUT_STRUCT).put(
            CheckpointSum.TYPE, CheckpointSum.DELTA).put(CheckpointSum.VALUE, 1.0d),
            aggregate);
        ...
        aggregate = udaf.aggregate(new Struct(INPUT_STRUCT).put(
            CheckpointSum.TYPE, CheckpointSum.ABSOLUTE).put(CheckpointSum.VALUE, 0.0d),
            aggregate);
        ...
        aggregate = udaf.aggregate(new Struct(INPUT_STRUCT).put(
            CheckpointSum.TYPE, CheckpointSum.ABSOLUTE).put(CheckpointSum.VALUE, 7.0d),
            aggregate);
        ...
        aggregate = udaf.aggregate(new Struct(INPUT_STRUCT).put(
            CheckpointSum.TYPE, CheckpointSum.ABSOLUTE).put(CheckpointSum.VALUE, 32.0d),
            aggregate);
    ...
    public void test2() {
        ...
        aggregate = udaf.aggregate(new Struct(INPUT_STRUCT).put(
            CheckpointSum.TYPE, CheckpointSum.ABSOLUTE).put(CheckpointSum.VALUE, 10.0d),
            aggregate);
